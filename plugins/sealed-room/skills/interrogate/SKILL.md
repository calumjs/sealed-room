...
Return **only** the spoken dialogue (optionally one short stage direction like *(she glances away)*). Nothing else. If the sheet line above said `NO_CASE` or `NO_MATCH`, relay that plainly instead.
